...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document settings
\title{Autonomous Border Surveillance System}
\subCode{AI367P}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Student Details%%%
\stuNameA{N Mohammed Akhil}
\stuUSNA{1RV23AI061}
\stuNameB{B Hanumanth}
\stuUSNB{1RV23CS060}
\stuNameC{K V Sai Charan}
\stuUSNC{1RV23EC063}
\stuNameD{Tanmay Sharad Joshi}
\stuUSND{1RV23EC166}
...
\guideNameA{Dr. K Vishwavardhan Reddy}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%  QRL %%%%%%%%%%%%%%%%%%%%%%%%%%
\QRurl{https://drive.google.com/file/d/1z53hD-r-LGR2_WYI6WNmN0z91Tl_Yjh1/view?usp=sharing}
