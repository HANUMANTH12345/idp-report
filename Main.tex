...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document settings
\title{Visual Inspection of Solar Farm}
\subCode{AI367P}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Student Details%%%
\stuNameA{Abhishek H G}
\stuUSNA{1RV24CS400}
\stuNameB{B Hanumanth}
\stuUSNB{1RV23CS060}
\stuNameC{B G Koushik}
\stuUSNC{1RV24CS403}
\stuNameD{Bheemaraj D }
\stuUSND{1RV23AI026}
...
\guideNameA{Dr Narasimha Swamy S}
...
\guideNameB{Dr Narasimha Swamy S}
\guideDesignationB{Associate  Professor}
\guideDeptB{Dept. of AIML}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%  QRL %%%%%%%%%%%%%%%%%%%%%%%%%%
\QRurl{https://drive.google.com/drive/folders/1KjfoaKe47uVfK3AUAEQ2kwCNXZQfm9cZ}
...
\ifINT
\else
\input{./Chapter7/chapter7-referances}
\fi
