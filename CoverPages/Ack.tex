...
%\textbf{Dr. Arulalan Rajan}, Professor, Department of Artificial Intelligence and Machine Learning, RVCE 
%for the timely instructions and support in coordinating the project.\\ \par
...
\ifPG My \else \ifStuNameBUsed Our \else My \fi\fi sincere thanks to \textbf{\printHOD}, Professor and program coordinator, Department of \ifIDP \printGuideDeptAInLF\else\printDepartmentLF \ \fi  and  \textbf{ Dr Shanta Rangaswamy} , Professor and Head ,Department of Computer Science and Engineeing, RVCE for the support and encouragement.\\ \par
